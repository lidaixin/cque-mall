...
<body>
<br><br><br><br>
<form class="form-horizontal" action="/admin1/addProduct" method="post">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <input type="text" name="marketPrice" class="form-control" id="marketPrice" placeholder="marketPrice">
        </div>
    </div>
    <div class="form-group">
        <label for="shopPrice" class="col-sm-2 control-label">shopPrice</label>
        <div class="col-sm-10">
            <input type="text" name="shopPrice" class="form-control" id="shopPrice" placeholder="shopPrice">
        </div>
    </div>
    <div class="form-group">
        <label for="pImage" class="col-sm-2 control-label">pImage</label>
        <div class="col-sm-10">
            <input type="text" name="pImage" class="form-control" id="pImage" placeholder="pImage">
        </div>
    </div>
    <div class="form-group">
        <label for="isHot" class="col-sm-2 control-label">isHot</label>
        <div class="col-sm-10">
            <input type="text" name="isHot" class="form-control" id="isHot" placeholder="isHot">
        </div>
    </div>
    <div class="form-group">
    ...
    <%--<div class="form-group">--%>
        ...
        <%--<div class="col-sm-10">--%>
            <%--<input type="text" name="cid" class="form-control" id="cid" placeholder="cid">--%>
        <%--</div>--%>
    <%--</div>--%>
    <div class="form-group">
