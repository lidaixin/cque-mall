            ...
            <div class="panel panel-info" style="margin: 0;height: 100%">
                ...
                <div class="panel-body" style="padding: 0">
                    <div class="list-group">
                        <a href="#" class="list-group-item">商品类别管理</a>
        ...
        <div class="cque-main">
            <div class="cque-list">
                <div class="cque-list-nav">
                    <a href="${pageContext.request.contextPath}/jsp/addCart.jsp">
                ...
                <div class="cque-list-content">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                        <c:forEach begin="1" end="9" items="${carts}" var="cart" varStatus="cartStatu">
                            <tr>
                                <td>${cartStatu.count}</td>
                                <td>${cart.cname}</td>
                                <td class="cque-td">
                                    <a href="${pageContext.request.contextPath}/jsp/updateCart.jsp?cid=${cart.cid}&cname=${cart.cname}">
                                        <button class="btn btn-default btn-primary" type="button">修改</button>
                                    </a>
                                    <button onclick="deleteItem(${cart.cid})" type="button" class="btn btn-primary">
                                        删除
                                    </button>
...
<script>
        ...
        function deleteItem(cid) {
            ...
            if (!isDel)
                return
            $.post('/admin1/deleteCategory', {cid: cid}, function (result) {
                // 跳转页面
                alert("删除成功")
                location.href = '/admin1/cart/list'
            })
        }
