...
<body>
<br><br><br><br>
<form class="form-horizontal" action="/admin1/addCategory" method="post">
    <div class="form-group">
        <label for="inputEmail3" class="col-sm-2 control-label">分类Id</label>
        <div class="col-sm-10">
            <input type="text" name="categoryId" class="form-control" id="inputEmail3" placeholder="分类Id">
        </div>
    </div>
    <div class="form-group">
        <label for="inputPassword3" class="col-sm-2 control-label">分类名称</label>
        <div class="col-sm-10">
            <input type="text" name="categoryName" class="form-control" id="inputPassword3" placeholder="分类名称">
        </div>
    </div>
    <div class="form-group">
